...
// Ethernet_Generic junk
	...
	#define USING_SPI2 true // This is just to make the library happy, SPI is selected below
		...
		#define PIN_SCK DCSBIOS_ESP32_ETHERNET_SCK
	#endif

	#ifdef DCSBIOS_ESP32_ETHERNET_MISO
		#define PIN_MISO DCSBIOS_ESP32_ETHERNET_MISO
	#endif

	#ifdef DCSBIOS_ESP32_ETHERNET_MOSI
		#define PIN_MOSI DCSBIOS_ESP32_ETHERNET_MOSI
	#endif
#endif
